  ...
  return (
    <div className="space-y-2">
      ...
      {filteredCancelled.map((item) => {
        ...
        return (
          <div key={`cancelled-${item.id}`} className="p-3 rounded-2xl border border-rose-200 bg-rose-50/60">
              ...
              <div className="min-w-0 lg:flex-1 space-y-1.5">
                ...
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  <span className="text-[10px] text-slate-600 bg-white/80 border border-slate-200 px-2 py-0.5 rounded-full">
                    Pax {paxTotal} - Adult {adultCount} - Children {childrenCount} - Sleeping {sleepingGuests}
                  </span>
                </div>
