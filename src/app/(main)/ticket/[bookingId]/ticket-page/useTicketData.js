      ...
      if (bookingData?.resort_id) {
        ...
        if (cachedResort) {
          ...
          const { data: resortData, error: resortError } = await supabase
            .from("resorts")
            .select("id, name, location, contactEmail, contactPhone, contactMedia, rooms, extraServices, payment_image_url, bank_payment_image_url, gcash_account_name, gcash_account_number, bank_name, bank_account_name, bank_account_number, rulesAndRegulations, termsAndConditions")
